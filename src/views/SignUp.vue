<template>
  <div class="home">
    ...
    <AccountLayout>
            ...
            :placeValue="$t('register.ImagePlaceHolder')"></ImageCode>
            ...
            @emailCodeTip="emailCodeTip"
						:placeValue="$t('register.verfPlaceHolder')"></SendEmailCode>
					...
					<BasicInput
						...
						class="account-input password-email"
            v-model="inputPw"
						:placeValue="$t('register.newPw')"></BasicInput>
					...
					<BasicInput
						...
						class="account-input password-email"
            v-model="inputSePw"
						:placeValue="$t('register.confirmPw')"></BasicInput>
